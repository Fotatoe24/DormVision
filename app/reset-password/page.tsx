...
export default async function ResetPasswordPage() {
  // The recovery link (via /auth/callback) has already exchanged the
  // code for a session by the time the user lands here — no session
  // means the link was invalid, expired, or already used.
